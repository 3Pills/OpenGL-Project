...
public:
	...
	void AddFBXModel(const char* a_filename, float a_roughness = 0.3f, float a_fresnelScale = 1.0f);
	void AddPhysModel(const char* a_filename, vec3 a_pos, PxGeometry* a_geometry, PxMaterial* a_physicsMaterial, float a_density = 10.0f, float a_roughness = 0.3f, float a_fresnelScale = 1.0f);
